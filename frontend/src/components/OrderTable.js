...
export default function OrderTable({ orders }) {
  ...
  const getStatusColor = (status) => {
    const statusMap = {
      "Pending Admin Confirmation": "bg-yellow-100 text-yellow-800 border-yellow-300",
      Confirmed: "bg-teal-100 text-teal-800 border-teal-300",
      Processing: "bg-blue-100 text-blue-800 border-blue-300",
      Shipped: "bg-purple-100 text-purple-800 border-purple-300",
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => {
                    ...
                    setNewStatus(order.status); // Pre-fill current status
                  }}
                  className="flex-1 bg-gray-100 text-indigo-600 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-200 transition"
                >
                  View Details
                ...
                {orderList.map((order) => (
                  ...
                  >
                    ...
                    <td className="px-4 xl:px-8 py-5 text-gray-700">
                      <div>
                        <p className="font-medium">{order.userName}</p>
                        <p className="text-xs text-gray-500 break-all">{order.email}</p>
                      </div>
                    </td>
                    <td className="px-4 xl:px-8 py-5 text-center">
                      {order.products.length}
                  ...
                  <div className="bg-gray-50 p-4 sm:p-5 rounded-xl border border-gray-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
                      >
